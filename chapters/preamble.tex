...
\usepackage{musicography} % music symbo
...
% set pages header and footers (moved to end of preface)
%-----------------------------
\titleformat{\part}[display] % define display format for Part title pages (also required to gain control over those, e.g., page numbers)
