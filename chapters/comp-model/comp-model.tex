...
Generally, low rate may lead to a slow (and potentially unnoticeable) change, while a high value might lead to a abrupt changes and constant overshooting from the system's side (see \cref{\cref{tab:validation_baseline},fig:validation_sensitivity}).
