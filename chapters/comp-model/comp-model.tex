...
This chapter introduces a model of the way accommodation occurs in human speech, based on the finding in the human-human and human-computer studies.
It's motivated by empirical data observed in these studies and aims to resemble the process that occurs in humans.
Several parameters can be tweaked to shape the desired vocal behavior.
