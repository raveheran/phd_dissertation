...
\todo[inline]{here give medium-length introduction how sales reps are taught to becoming more similar to the prospect AND making them more similar to them is a desired behavior. however, they don't learn how exactly to do it and not how to measure it. in c-iq analysis these only recently have started to be measurable characteristics that prove to contribute to conversation success.}
...
It complements other types of human intelligence (e.g., \emph{emotional intelligence}, c.f. \emph{Theory of Multiple Intelligences} \citep{Gardner1983frames, Davis2011theory}) as the ensemble of aspects conversations are handled \textbf{beyond the surface words and shared information}.
...
\todo{add 1-2 more key ideas from the book}
...
\todo{somewhere above mention that accommodation is at best a rare measure in C-IQ to link to this}
Although \ac{c-iq} doesn't traditionally use accommodation measures for evaluation, there has been some attempts to use the former for the latter's benefit.
...
\todo{refer to the place where the green-orange plot is shown and the limitation of DiD are explained as a motivation for using this method}
...
\begin{description}
	...
	\end{equation}
	\eqname{CRQA-based measures: RR, DET, NRLINE, L, maxL, ENTR, and rENTR}
	%
...
\begin{table}[t]
	...
	\begin{tabularx}{\linewidth}{X
		...
		\bottomrule	
	\end{tabularx}
	\todo[inline]{write a bit about insignificant results in bottom half of table}%
\end{table}
...
\todo[inline]{add paragraph about interactivity and talking ratios with the functions in conversation-funs.R (make a table for this or combine with first table if too little information). add 1-2 sentences describing this in an earlier section if necessary}
