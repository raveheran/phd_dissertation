...
\todo[inline]{can expand this more if have something else to say...}

\subsection{Speaker roles and influences in sales calls}
\label{subsec:speaker_roles_and_influences_in_sales_calls}

\todo[inline]{here provide concrete examples of behavior change and role detection/division in sales calls}
...
\todo[inline]{1-2 sentences connecting to time series}
...
\Cref{subsubsec:detecting_recurrence,subsubsec:parameters_crqa} explain the technicalities of \ac{crqa}, how its output can be interpreted, and how it is used in the studies presented here.
...
\todo[inline]{2-3 more sentences about each of those examples to show that CRQA is a valid technique}
...
\todo[inline]{1-2 sentence lead into feature extraction}
Feature extraction was\ldots\\
...
\todo[inline]{a few more sentences about how the values were transformed/shaped as time series, padded (look at R scripts, etc.)}
