...
\todo[inline]{the low level technical/mathematical details will probably move to the chapter about statistical modeling}

\todo[inline]{somewhere refer to the place where the green-orange plot is shown and the limitation of DiD are explained as a motivation for using this method}
