...
\todo[inline]{1-2 sentences explaining why then accommodation can contribute here}
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\linewidth]{crqa_plot_115993376241473405}
	...
	\label{fig:crqa_plot}
	\todo[inline]{consider taking another plot with more clear effects -- or no plot at all?}
...
\begin{figure}
	...
	\begin{minipage}{.45\linewidth}
		...
		\label{fig:false_nn}
	\end{minipage}	
	\todo[inline]{make text and lines/bars bigger}
\end{figure}
%
...
\begin{description}
	...
	\end{equation}
	\eqname{-- 4.4.5 \ac{crqa}-based measures: RR, DET, L, maxL, and ENTR}
	%
