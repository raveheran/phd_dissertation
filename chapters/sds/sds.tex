...
\putref{mention rule-based system or RL-based system (from Milica?), and adapting DM}
...
A \acl{pa} (\acs{pa}; frequently also \emph{intelligent \acl{pa}} or \emph{virtual \acl{pa}}\footnote{The term \emph{virtual assistant} is widely used as well.
...
This work addresses each of those facets (see the outline on pages \cpagerefrange{outline}{outline_end}).
