...
\begin{table}[tb]
	\centering
	\caption[Types of \aclp{sds}: Task-oriented vs.\ Chit-chats]{A comparison between task-oriented \acp{sds} and chit-chats.}
	\label{tab:sds_types}
...
A Chatbot (sometimes also called \emph{chatterbot}, \emph{chitchat bot}) is a\ldots
