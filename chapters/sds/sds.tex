...
In recent years, the market for commercial \acp{pa} has rapidly grown.
...
\todo[inline]{probably move these usage statistics to the relevant place in SDS tpyes}

In the future, we are likely to witness an ever-growing presence of devices with spoken interaction capabilities, like speech-activated cars, hands-free medical assistants, and \acp{its}.
