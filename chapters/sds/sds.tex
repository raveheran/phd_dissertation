...
Another category is voice-activated \ac{cnc} systems, which are arguably not \acp{sds}, since they only rarely engage in conversation  or trigger a multi-turn dialogue.
...
Commercial voiced-based \acp{pa} include Amazon Alexa, Apple Siri, Google Assistant, Microsoft Cortana, and many more less famous ones.
