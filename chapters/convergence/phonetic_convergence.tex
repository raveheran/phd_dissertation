...
\begin{table}[t]
	...
	\caption[Comparison of variation types]
		...
		The \emph{mutuality} column marks whether the process occurs in both interlocutors.
		\emph{directionality} indicates whether the process is defined in a specific direction (similarity or dissimilarity).
		\emph{Intention/awareness} imply that the process is performed consciously, and the last column shows whether the process' trajectory advances toward a specific, potentially relative, \emph{target} value or not. 
