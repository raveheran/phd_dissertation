...
\todo[inline]{takes paragraphs/examples from 1.2 in Iona's paper}

\citet{Aubanel2020speaking}  % example for f0
\citet{Babel2012role} % example for f0
\citet{Lehnert2020relationship} % reversed correlation between language-skill and expressiveness of f0 to contribution to mutual accommodation
\citet{Local2007phonetic} % example for speech rate
\citet{Natale1975convergence} % intensity
\citet{Edlund2009pause} % pause duration
\citet{Borrie2017conversational} % voice quality
\citet{Law2020convergence} % L2 speakers (has more for L2 inside)
% Jan Michalsky has 2 (or more) papers aboutthe connection between accommodation and attractiveness and conversational quality:
% Conversational quality is affected by and reflected in prosodic entrainment
% Pitch Convergence as an Effect of Perceived Attractiveness and Likability
\citet{Baumann2020how} % influence of feedback on convergence

% examples for non-speech accommodation
\citet{Racz2020morphological}  % example for accommodation in morphology
\citet{Lopes2013lexical} % lexical entrainment
\citet{Bergqvist2020nontrivial} % lexical convergence
