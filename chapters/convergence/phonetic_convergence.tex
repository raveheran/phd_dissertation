...
Similarly, the models and applications in \crefrange{chap:computational_model}{chap:web-based_responsive_spoken_dialogue_system} are also designed to handle accommodation-related changed within the scope of time-limited interactions.
...
These reason and others are explained from the phonetic point of view in \citet{Sweet1874history}.
