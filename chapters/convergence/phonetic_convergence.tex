...
\Cref{subsec:variation_types} sheds more light on the difference between the various terms used to describe this process and how they are used in the literature.
...
both in conversational \citep{Pardo2006phonetic, Lewandowski2012talent} and non-conversational \citep{Babel2014novelty, Shockley2004imitation} scenarios.
...
As demonstrated by \citet{Pardo2013measuring}, vocal accommodation can occur with respect to various phonetic features.
...
Relatedly, \citet{Edlund2009pause} introduces a way to measure temporal prosodic changes, like pauses, in conversation, which affect the speaking rate.
...
\todo[inline]{a bit about interaction vs.\ conversation. say that there often used interchangeably in this work in the context of spoken interaction between two interlocutors.}

\todo[inline]{here talk about the very elementary properties of what is actually an interaction in general.}

\todo[inline]{say that his term is used a lot in this work, so it is explained here.}

%\subsection{Interacting with computers}
%\label{sec:subinteracting_with_computers}
...
\todo[inline]{say how in most ways to interacts with computers humans need to learn new ways to interact or at the very least change a known way. this is true also for speech, although it's improving. as it's improving, people start to talk more naturally to machines, and therefore also natural phenomena, like accommodation, are expected to occur.}
...
\todo[inline]{this rises the question whether the social motivation of CAT is valid in HCI. mention CASA and other things from the second part of 1.2 in Iona's paper}
...
\citet{Lopes2013lexical} % lexical entrainment
\citet{Bergqvist2020nontrivial} % lexical convergence in dialogue system
\citep{Lopes2013automated} % improve performance
...
Phonetic convergence is often examined in the scope of shadowing experiments, in which the participants are asked to repeat utterances spoken by an interlocutor \citep{Pardo2017phonetic, Dias2016visibilivty, Walker2015repeat, Shockley2004imitation}.
...
\todo[inline]{make sure there are only HCI papers here as examples}