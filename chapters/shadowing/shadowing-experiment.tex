...
To confirm that the changes were subtle and were ascribed mostly to larger deviation, a distributional comparison between the baseline and shadowing productions for each participant.
These comparison are shown in \cref{fig:violin_facet_dev}.
...
This assumption is made, whether explicitly or implicitly, in accommodative system like those surveyed in \cref{sec:adaptive_spoken_dialogue_systems}.
...
Although these feature may pass as light dialectical markers \citep{Mitterer2013regional}, they do not carry any difference in meaning, and are generally ascribed to personal preference and speaking style.
...
The influence of the production overlaps are discussed in \cref{sec:conclusion_shadowing}.
%
\begin{table}[t]
	\centering 
