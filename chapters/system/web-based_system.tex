...
\todo[inline]{add a screenshot of the entire GUI (landscape)? have some in presentations etc.}
...
To demonstrate the capabilities of the system, it was utilized to replicate a convergence experiment.
