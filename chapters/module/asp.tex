...
\todo[inline]{short section to explain how the ASP module is integrated into the SDS. talk a bit why it's separate (and not inside TTS) -- allow processing in parallel and treat the accommodation as a separate process in the system, which could, in theory, also be used to influence NLG or DM}
...
\todo[inline]{from IS 2017. can probably be taken as-is from System chapter.}

\section{Speech manipulation}
\label{sec:speech_manipulation}
