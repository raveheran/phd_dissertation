...
\lettrine{P}{roducing} accommodative speech output in \aclp{sds} requires additional functionality that extracts speech properties from the user's input to consider when generating the system's output.
