\chapter{Accommodation in Multiparty Interactions with an Agent}
...
The results presented in \cref{tab:results_hhci_addressee,tab:signif_conditions} show for all three features
\begin{enumerate*}[(a)]
